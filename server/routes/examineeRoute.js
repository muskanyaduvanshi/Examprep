    ...
    <div style="max-width: 650px; margin: auto; background: #ffffff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); overflow: hidden;">
      ...
      <div style="padding: 30px;">
        ...
        <p style="font-size: 16px; color: #555; line-height: 1.6;">
          We're excited to welcome you to the <strong>Exam Prep</strong>! Your registration was successful, and your account is now active.
        </p>
...
router.post('/login', async (req, res) => {
  ...
  if (examinee.password === password) {
    ...
    return res.json({ message: "Your Password Incorrect" });  // ✅ added
  }
});
