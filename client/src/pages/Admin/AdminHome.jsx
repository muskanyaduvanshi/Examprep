...
const AdminHome = () => {
  ...
  return (
    <div style={{ padding: "15px", fontFamily: "Arial" }}>
      ...
      {/* Cards Section */}
      <div style={{ display: "flex", gap: "60px", marginTop: "10px", flexWrap: "wrap" }}>
        <DashboardCard
          color="linear-gradient(135deg, #4c2451ff, #8845a1ff)"
          title="Total Exams"
          count={data.totalExams}
          icon={<FaClipboardList size={28} />}
        />
        <DashboardCard
          color="linear-gradient(135deg, #d558e6ff, #8845a1ff)"
          title="Total Examinees"
          count={data.totalExaminees}
          icon={<FaUsers size={28} />}
        />
        <DashboardCard
          color="linear-gradient(135deg, #eb79f1ff, #cf4ceaff)"
